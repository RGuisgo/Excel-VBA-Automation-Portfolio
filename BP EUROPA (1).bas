...
Public Sub automatenettingRECEIVABLEBPEUROPA()
    ...
    Next i
    session.findById("wnd[0]/tbar[1]/btn[16]").press
    'session.findById("wnd[1]/tbar[0]/btn[0]").press - withholding tax thing
    session.findById("wnd[0]/tbar[1]/btn[14]").press
    session.findById("wnd[0]/usr/ctxtRF05A-NEWBS").Text = "04"
    session.findById("wnd[0]/usr/ctxtRF05A-NEWKO").Text = 785235
    ...
    session.findById("wnd[0]/usr/ctxtBSEG-SGTXT").caretPosition = 8
    session.findById("wnd[0]").sendVKey 0
    session.findById("wnd[0]").sendVKey 0
    'session.findById("wnd[0]").sendVKey 0
   ' session.findById("wnd[0]/tbar[1]/btn[14]").press
